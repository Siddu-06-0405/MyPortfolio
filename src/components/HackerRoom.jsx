...
export function HackerRoom(props) {
  ...
  const txt = useVideoTexture(props.texture ? props.texture : '/textures/project/guts.mp4');
  useEffect(() => {
    if (nodes['monitor-screen']) {
      const geometry = nodes['monitor-screen'].geometry;
      const uvAttribute = geometry.attributes.uv;

      // Flip the UVs vertically
      for (let i = 0; i < uvAttribute.count; i++) {
        uvAttribute.setY(i, 1 - uvAttribute.getY(i)); // Flip the Y component of the UVs
      }
      uvAttribute.needsUpdate = true; // Mark the UVs as updated
    }
  }, [nodes]);
